...
class plgJ2StorePayment_zarinpal extends J2StorePaymentPlugin
{
	 ...
	 * @since 2.5
	 */
	function plgJ2StorePayment_zarinpal(& $subject, $config)
	{
    ...
    function _prePayment( $data )
    {
        ...
        $vars->MerchantID = $this->params->get('merchant_id', JText::_( "PLG_J2STORE_PAYMENT_BANKTRANSFER"));
        $vars->onbeforepayment_text = $this->params->get('onbeforepayment', '');
        $vars->button_text = $this->params->get('button_text', 'J2STORE_PLACE_ORDER');
        $vars->Address = $this->params->get('Address');
