...
<form action="<?php echo JRoute::_( JURI::root().'plugins/j2store/payment_zarinpal/payment_zarinpal/tmpl/pay.php'); ?>" method="post" name="adminForm" enctype="multipart/form-data">
    ...
    <input type='hidden' name='orderpayment_type' value='payment_zarinpal'>
